...
const AffiliateFeat4 = () => {
  return (
    <section className="mt-5 mb-3 container row mx-auto">
      <div>
        <h2 className="text-center section__title section__title--services">
          Who Are You??
        </h2>
      </div>
      <div className="d-flex container row g-5 mx-auto platformfeat3">
        <div className="col-md-4 card bg-secondary text-white">
          ...
          <p className="">
            ...
            new customer acquisition, to purchase, high-value shoppers, or
        ...
        <div className="col-md-4 card bg-secondary text-white">
          ...
          <p className="">
            ...
            email, mobile apps, offline marketing, and more.
          </p>
        </div>
      </div>
    </section>
